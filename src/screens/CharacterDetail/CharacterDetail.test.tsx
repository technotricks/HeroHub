...
describe('Character Detail Screen', () => {
  it('Character Add and Remove fav click should render properly', async () => {
    ...
    await waitFor(() => screen.getByTestId('favButtonID'));

    const button = screen.getByTestId('favButtonID');

    fireEvent.press(button); //Remove from fav
    fireEvent.press(button); //Add to Fav
